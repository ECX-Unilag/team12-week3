    ...
    return (
        <section id="states">
            ...
            <div className="states row">
                <div className="state-item col-lg-4 col-md-6 col-sm-6" data-aos="zoom-out"  data-aos-delay="300">
                    <img src="img/kajuru1.jpg" alt="Kajuru Estate, Kaduna state" />
                ...
                <div className="state-item col-lg-4 col-md-6 col-sm-6" data-aos="zoom-out"  data-aos-delay="300">
                    <img src="img/Obudu.jpg" alt="Obudu Cattle Ranch, Cross River State" />
                ...
                <div className="state-item col-lg-4 col-md-6 col-sm-6" data-aos="zoom-out"  data-aos-delay="300">
                    <img src="img/Osun-sacred.jpg" alt="Osun Sacred Groove, Osun State" />
                ...
                <div className="state-item col-lg-4 col-md-6 col-sm-6" data-aos="zoom-out"  data-aos-delay="300">
                    <img src="img/nike.jpg" alt="Nike Art Gallery, Lagos State" />
                ...
                <div className="state-item col-lg-4 col-md-6 col-sm-6" data-aos="zoom-out"  data-aos-delay="400">
                    <img src="img/zuma-rock.jpg" alt="Zuma Rock, Abuja" />
                ...
                <div className="state-item col-lg-4 col-md-6 col-sm-6" data-aos="zoom-out"  data-aos-delay="400">
                    <img src="img/agodi.jpg" alt="Agodi Gardens, Oyo State" />
